...
if __name__ == '__main__':
    ...
    dim_c, dim_h, dim_N, dim_E, dt = 8, 8, 3, 1, 1.0/24.0
    ...
    func = ODEJumpFunc(dim_c, dim_h, dim_N, dim_E, dim_hidden=16, num_hidden=2, jump_type=args.jump_type, evnt_align=args.evnt_align, activation=nn.CELU(), ortho=True, evnt_embedding="continuous")
