...
run_point_process:
	taskset --cpu-list 0 python point_processes.py --dataset poisson            --niters 3000 --jump_type read --batch_size 30 --nsave 200 --seed0 &
	taskset --cpu-list 1 python point_processes.py --dataset exponential_hawkes --niters 3000 --jump_type read --batch_size 30 --nsave 200 --seed0 &
	taskset --cpu-list 2 python point_processes.py --dataset self_inhibiting    --niters 3000 --jump_type read --batch_size 30 --nsave 200 --seed0 &
	taskset --cpu-list 3 python point_processes.py --dataset powerlaw_hawkes    --niters 3000 --jump_type read --batch_size 30 --nsave 200 --seed0 &
