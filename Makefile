...
run_mimic2:
	taskset --cpu-list 4 python mimic2.py --niters 10000 --fold 0 --jump_type read --batch_size 30 --nsave 500 --seed0 &
	taskset --cpu-list 5 python mimic2.py --niters 10000 --fold 1 --jump_type read --batch_size 30 --nsave 500 --seed0 &
	taskset --cpu-list 6 python mimic2.py --niters 10000 --fold 2 --jump_type read --batch_size 30 --nsave 500 --seed0 &
	taskset --cpu-list 7 python mimic2.py --niters 10000 --fold 3 --jump_type read --batch_size 30 --nsave 500 --seed0 &
	taskset --cpu-list 8 python mimic2.py --niters 10000 --fold 4 --jump_type read --batch_size 30 --nsave 500 --seed0 &
