...
run_stack_overflow:
	taskset --cpu-list 0 python stack_overflow.py --niters 1500 --fold 0 --jump_type read --batch_size 30 --nsave 2000 --seed0 &
	taskset --cpu-list 1 python stack_overflow.py --niters 1500 --fold 1 --jump_type read --batch_size 30 --nsave 2000 --seed0 &
	taskset --cpu-list 2 python stack_overflow.py --niters 1500 --fold 2 --jump_type read --batch_size 30 --nsave 2000 --seed0 &
	taskset --cpu-list 3 python stack_overflow.py --niters 1500 --fold 3 --jump_type read --batch_size 30 --nsave 2000 --seed0 &
