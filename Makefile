...
run_twitter:
	taskset --cpu-list 0 python tweet.py --dataset politics  --niters 1000 --jump_type read --batch_size 30 --nsave 200 --seed0 &
	taskset --cpu-list 1 python tweet.py --dataset movie     --niters 1000 --jump_type read --batch_size 30 --nsave 200 --seed0 &
	taskset --cpu-list 2 python tweet.py --dataset fight     --niters 1000 --jump_type read --batch_size 30 --nsave 200 --seed0 &
	taskset --cpu-list 3 python tweet.py --dataset bollywood --niters 1000 --jump_type read --batch_size 30 --nsave 200 --seed0 &
