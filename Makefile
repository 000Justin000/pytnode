...
run_coupled_oscillators:
	taskset --cpu-list 3 python coupled_oscillators.py --niters 100000 --batch_size 300 --suffix _restart --nsave 500 --debug --restart > three_body/${COMMIT}.log 2> three_body/${COMMIT}.error &
