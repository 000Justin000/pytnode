run_rnn_point_process:
	taskset --cpu-list 0 python rnn_point_processes.py --dataset poisson            --niters 6000 --jump_type read --batch_size 30 --nsave 50 --seed0 --evnt_align &
	taskset --cpu-list 1 python rnn_point_processes.py --dataset exponential_hawkes --niters 6000 --jump_type read --batch_size 30 --nsave 50 --seed0 --evnt_align &
	taskset --cpu-list 2 python rnn_point_processes.py --dataset self_inhibiting    --niters 6000 --jump_type read --batch_size 30 --nsave 50 --seed0 --evnt_align &
	taskset --cpu-list 3 python rnn_point_processes.py --dataset powerlaw_hawkes    --niters 6000 --jump_type read --batch_size 30 --nsave 50 --seed0 --evnt_align &
